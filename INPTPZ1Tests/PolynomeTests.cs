...
namespace INPTPZ1Tests
{
    ...
    class PolynomeTests
    {
        ...
        {
            Polynome polynome = new Polynome();
            polynome.Add(new ComplexNumber { Real = 10, Imaginari = 10 });
            polynome.Add(new ComplexNumber { Real = 20, Imaginari = 20 });
            Polynome expectedPolynome = new Polynome();
            expectedPolynome.Add(new ComplexNumber { Real = 20, Imaginari = 20 });
        ...
        public void EvaluateRealNumber()
        {
            Polynome polynome = new Polynome();
            polynome.Add(new ComplexNumber { Real = 10, Imaginari = 10 });
            polynome.Add(new ComplexNumber { Real = 5, Imaginari = 5 });
            ComplexNumber result = polynome.Evaluate(5);
            ComplexNumber expectedResult = new ComplexNumber { Real = 35, Imaginari = 35 };
        ...
        public void EvaluateComplexNumber()
        {
            ...
            polynome.Add(new ComplexNumber { Real = 10, Imaginari = 10 });
            polynome.Add(new ComplexNumber { Real = 5, Imaginari = 5 });
            ComplexNumber result = polynome.Evaluate(new ComplexNumber { Real = 20, Imaginari = 20 });
            ComplexNumber expectedResult = new ComplexNumber { Real = 10, Imaginari = 210 };
            Assert.AreEqual(expectedResult, result);
